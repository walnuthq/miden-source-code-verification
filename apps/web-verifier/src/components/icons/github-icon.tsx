// lucide-react 1.x dropped brand icons, so the GitHub mark is provided as an
// inline SVG. Sized via currentColor + no width/height so the parent Button's
// icon styles control dimensions (matching lucide icons).
