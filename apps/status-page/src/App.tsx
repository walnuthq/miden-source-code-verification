        ...
        {state.phase === "ready" && (
          <>
            ...
            <p className="text-xs text-muted-foreground">
              Checks run hourly from GitHub Actions against each service's{" "}
              <code className="font-mono">/</code> endpoint. This page is a
              snapshot from the last run, not a live probe.
            </p>
          </>
        )}
      </main>
