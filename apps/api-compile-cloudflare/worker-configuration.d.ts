/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 9969cea3a10bee85c74449d9598725ca)
// Runtime types generated with workerd@1.20260630.1 2026-06-01 nodejs_compat
interface __BaseEnv_Env {
	PORT: "8080";
	ALLOWED_ORIGINS: "*";
	CARGO_TARGET_DIR: "/cache/target";
	MIDENC_TARGET_DIR: "/cache/target/miden";
	MIDEN_VERIFIER_CACHE_DIR: "/cache";
	COMPILER: DurableObjectNamespace<import("./src/server").Compiler>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server");
		durableNamespaces: "Compiler";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PORT" | "ALLOWED_ORIGINS" | "CARGO_TARGET_DIR" | "MIDENC_TARGET_DIR" | "MIDEN_VERIFIER_CACHE_DIR">> {}
}
